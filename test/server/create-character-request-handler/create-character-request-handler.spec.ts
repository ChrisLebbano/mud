import { CreateCharacterRequestHandler } from "../../../src/server/create-character-request-handler";
import { type CharacterNameValidationResult, type CharacterRecord } from "../../../src/server/types/character";
