import { SignupRequestHandler } from "../../../src/server/signup-request-handler";
import { type UserCreateData, type UserRecord, type UserSignupPayload } from "../../../src/server/types/user";
