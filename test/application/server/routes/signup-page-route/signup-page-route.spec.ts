import { SignupPageRoute } from "../../../../../src/application/server/routes/signup-page-route";
...
describe(`[Class] SignupPageRoute`, () => {

    describe(`[Method] handle`, () => {

        it(`should serve the signup page html`, () => {
            const route = new SignupPageRoute();
