...
export class CharacterListRequestHandler {
    ...
    public handle(request: IncomingMessage, response: ServerResponse): void {
        ...
        const run = async (): Promise<void> => {
            ...
            const characters = await this._characterRepository.findByUserId(user.id);
        ...
        void run().catch((error: unknown) => {
            ...
            console.error(`[ERROR] Character list retrieval failed: ${message}`);
