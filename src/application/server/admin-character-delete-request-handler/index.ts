...
export class AdminCharacterDeleteRequestHandler {
    ...
    public handle(request: IncomingMessage, response: ServerResponse): void {
        ...
        const run = async (): Promise<void> => {
            ...
            const deleted = await this._characterRepository.markDeletedByIdForAdmin(characterId);
        ...
        void run().catch((error: unknown) => {
            ...
            console.error(`[ERROR] Admin character deletion failed: ${message}`);
